            ...
            <ul className="moviebox padding0" key={movie.id}>
              <div className="movieboxDiv">
                ...
                <li className="genresInBox">
                  {props.getGenre(movie.genre_ids)}
                </li>
        ...
        {genres.map(function(genre) {
          return (
            <Link
              ...
              onClick={props.changeGenre.bind(null, genre)}
              key={genre}
            >
              {genre}
            </Link>
...
class Home extends Component {
  ...
  genreChanger(genre) {
    this.state.genres.map(
      function(genres) {
        genres.name === genre &&
          this.setState({ genre: genres.id, genreName: genre, page: 1 }, () => {
            this.getPopularMovies();
          });
      }.bind(this)
    );
        ...
        <ul className="padding0">
          {this.state.movies !== null && (
            <Result
              ...
              data={this.state.movies.data.results}
            />
          )}
        </ul>
          ...
          <ul>
            ...
            <li>
              <div className="pageinput">
                ...
                <button
                  className="btn"
                  onClick={this.changePageFromInput.bind(
                    null,
